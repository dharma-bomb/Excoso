...
const firebaseConfig = {
  ...
  projectId: "excoso",
  // Firebase Storage is not used by this project — images are uploaded to
  // Cloudinary instead (see js/cloudinary-config.js), so no storageBucket
  // value or firebase-storage-compat.js script is needed.
